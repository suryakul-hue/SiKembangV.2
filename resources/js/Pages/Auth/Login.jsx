...
export default function Login({ status, canResetPassword, googleClientId }) {
    ...
    return (
        <GuestLayout>
            <Head title="Masuk - Platform Kesehatan" />
            ...
            <style>{`
                ...
                * {
                ...
                .login-form {
                    ...
                    gap: 24px;
                    animation: slideUp 0.6s ease-out ${isVisible ? '0.5s' : '0s'} both;
                }
                ...
                .signup-section {
                    ...
                    text-align: center;
                    animation: slideUp 0.6s ease-out ${isVisible ? '0.6s' : '0s'} both;
                }
                ...
                .security-info {
                    ...
                    font-size: 12px;
                    color: var(--gray-400);
                    animation: slideUp 0.6s ease-out ${isVisible ? '0.7s' : '0s'} both;
                }
            ...
            <div className="login-wrapper">
                <div className="login-card">
                    ...
                    <div className="login-header">
                        ...
                        <p>Masuk ke akun kesehatan Anda untuk melanjutkan</p>
                    </div>
                    ...
                    >
                        {isGoogleLoading ? (
                            <>
                                <svg className="google-icon spin" fill="none" viewBox="0 0 24 24">
                    ...
                    <button
                        ...
                        disabled={isGoogleLoading || isFacebookLoading || processing}
                        className="facebook-button"
                    >
                        {isFacebookLoading ? (
                            <>
                                <svg className="facebook-icon spin" fill="none" viewBox="0 0 24 24">
                                    <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                                    <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                                <span>Memproses...</span>
                            ...
                            <>
                                <svg className="facebook-icon" viewBox="0 0 24 24" fill="#1877F2">
                                    <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.99 3.66 9.13 8.44 9.88v-6.99h-2.54V12h2.54V9.79c0-2.51 1.49-3.89 3.78-3.89 1.09 0 2.24.2 2.24.2v2.46h-1.26c-1.24 0-1.63.77-1.63 1.56V12h2.78l-.44 2.89h-2.34v6.99C18.34 21.13 22 16.99 22 12z" />
                                </svg>
                    ...
                    <div className="divider-container">
                        ...
                        <div className="divider-text">Atau masuk dengan email</div>
                    </div>
                            ...
                            {errors.email && (
                                <div className="error-message">
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fillRule="evenodd" d="M18.101 12.93a1 1 0 00-1.414-1.414L10 14.586 5.313 9.899a1 1 0 00-1.414 1.414l5.5 5.5a1 1 0 001.414 0l8.5-8.5z" clipRule="evenodd" />
                                    </svg>
                                    {errors.email}
                                </div>
                            )}
                            ...
                            <label className="remember-label">
                                <input
                                    ...
                                    style={{
                                        ...
                                        height: '18px',
                                        cursor: 'pointer',
                                        accentColor: 'var(--health-primary)',
                                    }}
                                />
