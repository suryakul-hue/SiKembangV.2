            ...
            <div className="login-wrapper">
                <div className="login-card">
                    ...
                    <div className="login-header">
                        ...
                        <h1>Daftar Akun</h1>
                        <p>Buat akun baru untuk mulai memantau tumbuh kembang anak</p>
                    </div>
                    ...
                    <div className="divider-container">
                        ...
                        <div className="divider-text">Atau daftar dengan email</div>
                    </div>
                    ...
                    <form onSubmit={submit} className="login-form">
                        ...
                        <div className="form-group">
                            ...
                            {errors.age && (
                                <div className="error-message">
                                    <span className="text-xs">⚠️ {errors.age}</span>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            {errors.phone && (
                                <div className="error-message">
                                    <span className="text-xs">⚠️ {errors.phone}</span>
                                </div>
                            )}
                        </div>
