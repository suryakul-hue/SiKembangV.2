import{c as e,i as t,n,o as r,r as i,t as a,u as o}from"./app-DLhu_Xmb.js";import"./TextInput-A4xoZGEa.js";import"./InputLabel-D0cvtjSD.js";import"./PrimaryButton-Q0EUlkFW.js";import{t as s}from"./GuestLayout-DVaow0LK.js";var c=a(),l=o(e(),1);function u({status:e,canResetPassword:a,googleClientId:o}){let{data:u,setData:d,post:f,processing:p,errors:m,reset:h}=t({email:``,password:``,remember:!1}),[g,_]=(0,l.useState)(!1),[v,y]=(0,l.useState)(!1),[b,x]=(0,l.useState)(!1),[S,C]=(0,l.useState)(!1);(0,l.useEffect)(()=>{C(!0)},[]);let w=e=>{e.preventDefault(),f(route(`login`),{onFinish:()=>h(`password`)})},T=()=>{y(!0),window.location.href=route(`auth.google`)},E=()=>{x(!0),window.location.href=route(`auth.facebook`)};(0,l.useEffect)(()=>{o&&window.google&&(window.google.accounts.id.initialize({client_id:o,callback:D,auto_select:!1,cancel_on_tap_outside:!0}),window.google.accounts.id.prompt(e=>{e.isNotDisplayed()||e.isSkippedMoment()}))},[o]);let D=e=>{r.post(route(`auth.google.callback`),{credential:e.credential},{onFinish:()=>y(!1),onError:()=>y(!1)})};return(0,c.jsxs)(s,{children:[(0,c.jsx)(n,{title:`Masuk - Platform Kesehatan`}),(0,c.jsx)(`style`,{children:`
