import{c as e,i as t,n,r,t as i,u as a}from"./app-Dq7ex7Hw.js";import"./TextInput-Bqg2aVeU.js";import"./InputLabel-CKb9HJcf.js";import"./PrimaryButton-WsFS_l6f.js";import{t as o}from"./GuestLayout-3H8N_a9f.js";var s=a(e(),1),c=i();function l({appName:e=`SiKembang`}){let{data:i,setData:a,post:l,processing:u,errors:d,reset:f}=t({name:``,age:``,phone:``,email:``,password:``,password_confirmation:``}),[p,m]=(0,s.useState)(!1),[h,g]=(0,s.useState)(!1),[_,v]=(0,s.useState)(0),[y,b]=(0,s.useState)(!1),[x,S]=(0,s.useState)(!1),[C,w]=(0,s.useState)(!1);(0,s.useEffect)(()=>{b(!0)},[]);let T=e=>{e.preventDefault(),l(route(`register`),{onFinish:()=>f(`password`,`password_confirmation`)})},E=()=>{S(!0),window.location.href=route(`auth.google`)},D=()=>{w(!0),window.location.href=route(`auth.facebook`)};(0,s.useEffect)(()=>{let e=0;i.password.length>6&&e++,i.password.length>10&&e++,/[A-Z]/.test(i.password)&&e++,/[0-9]/.test(i.password)&&e++,/[^A-Za-z0-9]/.test(i.password)&&e++,v(e)},[i.password]);let O=()=>_<=2?`bg-red-500`:_<=3?`bg-yellow-500`:`bg-emerald-500`;return(0,c.jsxs)(o,{children:[(0,c.jsx)(n,{title:`Daftar - ${e}`}),(0,c.jsx)(`style`,{children:`
